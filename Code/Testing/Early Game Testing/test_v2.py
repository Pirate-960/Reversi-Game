...
# import statement
from Code.Game.Othello_v2 import Othello, OthelloAI, Tee
...
def test_ai_performance():
    ...
    results_file = f"Performance Test/Version (2)/ai_performance_test_{timestamp}.csv"
...
if __name__ == "__main__":
    ...
    files = glob.glob("Performance Test/Version (2)/ai_performance_test_*.csv")
    if files:
